...
;; Plan C: 中英文仓耳今楷
(setq doom-font (font-spec :family "TsangerJinKai05" :size 22)
      doom-serif-font doom-font
      doom-symbol-font (font-spec :family "TsangerJinKai05")
      doom-variable-pitch-font (font-spec :family "TsangerJinKai05" :weight 'extra-bold))
